  ...
  return (
    <div className="min-h-screen bg-slate-950/40 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl relative">
        {/* Close Button */}
        <button title="Close" className="absolute top-6 right-6 text-slate-400 hover:text-slate-600 z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 md:p-12">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="border border-slate-200 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-slate-900">Trusted Network</h3>
                </div>
                <p className="text-sm text-slate-600">Verified profiles from recognized Sri Lankan universities.</p>
              </div>
              ...
              <div className="border border-slate-200 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-semibold text-slate-900">Flexible Earns</h3>
                </div>
                <p className="text-sm text-slate-600">Swap for skills or set your preferred rates.</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-between">
            {/* Setup Progress */}
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-6">Setup Progress</h2>
              ...
              <div className="flex gap-4 mb-8">
                ...
                <div className="flex-grow">
                  ...
                  <div className="flex gap-2 mt-2">
                    ...
                    <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">Math</span>
                    <span className="text-xs bg-slate-100 text-slate-700 px-2 py-1 rounded">Add Skill +</span>
                  </div>
                </div>
              </div>
