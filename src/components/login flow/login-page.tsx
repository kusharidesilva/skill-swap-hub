          ...
          <div className="relative">
            ...
            <div className="mt-10">
              ...
              <p className="mt-4 max-w-md text-sm text-white/80">
                Join a trusted student-only platform to share skills, request support, and connect
                with verified university students.
              </p>
            </div>
          </div>
            ...
            <form className="mt-8 space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/forgot-password" className="text-xs font-semibold text-[#0f4cbf]">
                    Forgot Password?
                  </Link>
                </div>
                <div className="mt-2 flex items-center gap-3 rounded-lg border border-slate-200 px-3 py-2">
...
function BadgeIcon({ type, className }: { type: Badge["icon"]; className?: string }) {
  if (type === "cap") {
    return (
