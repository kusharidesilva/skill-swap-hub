const steps = [
  {
    title: "Verify Email",
    description: "Sign up with your .edu email address to join the verified student network.",
  },
  {
    title: "Post Skills",
    description: "List what you can teach and what you want to learn to build your profile.",
  },
  {
    title: "Match and Swap",
    description: "Connect with peers, arrange a session, and start mastering new skills together.",
  },
];
    ...
    <section className="bg-white">
      <div className="mx-auto max-w-6xl px-6 py-14">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-600">Simple steps to start learning and teaching.</p>
        </div>
