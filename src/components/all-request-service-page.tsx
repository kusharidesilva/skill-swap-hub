...
export default function AllRequestServicePage({
  ...
  return (
    <div className="flex w-full max-w-[1080px] flex-col gap-8 pb-10">
      ...
      {/* Request cards */}
      <section className="grid items-stretch gap-4 md:grid-cols-2 xl:grid-cols-3 xl:auto-rows-fr">
...
function RequestCard({
  ...
  return (
    <article className="flex h-full min-h-[324px] flex-col self-stretch rounded-2xl border border-slate-200 bg-white p-2.5 shadow-[0_8px_18px_rgba(15,23,42,0.025)]">
      ...
      {request.review && (
        <div className="mt-1.5 rounded-lg border border-emerald-100 bg-emerald-50/60 p-1.5 text-[9.5px] text-emerald-800">
          ...
          <p className="mt-1 line-clamp-2 italic">&ldquo;{request.review.comment}&rdquo;</p>
        </div>
      )}
        ...
        <div className="mt-auto border-t border-slate-200 pt-2">
          ...
          <div className="grid gap-2">
            ...
            <div className="grid gap-2 sm:grid-cols-2 xl:grid-cols-1 2xl:grid-cols-2">
              <button
                ...
                className="inline-flex h-9 items-center justify-center rounded-lg bg-emerald-600 px-3 text-xs font-bold text-white transition hover:bg-emerald-700"
              >
                Accept & Review
              </button>
              <button
          ...
          <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50/40 p-2.5">
            ...
            <textarea
              ...
              className="mt-2 w-full resize-none rounded-lg border border-slate-300 bg-white px-3 py-2 text-xs text-slate-700 outline-none focus:border-[#2f66e7] focus:ring-2 focus:ring-blue-100"
            />
