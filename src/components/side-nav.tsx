...
function SettingsIcon({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M19 12a1 1 0 0 0 .22.62l1.2 1.46-1.6 2.77-1.83-.43a1 1 0 0 0-.87.18l-.38.29a1 1 0 0 0-.39.73L15 20h-3l-.35-1.78a1 1 0 0 0-.39-.73l-.38-.29a1 1 0 0 0-.87-.18l-1.83.43-1.6-2.77 1.2-1.46A1 1 0 0 0 7 12a1 1 0 0 0-.22-.62l-1.2-1.46 1.6-2.77 1.83.43a1 1 0 0 0 .87-.18l.38-.29a1 1 0 0 0 .39-.73L12 4h3l.35 1.78a1 1 0 0 0 .39.73l.38.29a1 1 0 0 0 .87.18l1.83-.43 1.6 2.77-1.2 1.46A1 1 0 0 0 19 12z" />
    </svg>
  );
}
